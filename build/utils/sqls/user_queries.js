...
exports.checkIfEmailExistSql = exports.getUserBankAccountsSql = exports.searchUserProfileByNameSql = exports.getUserProfileByPhoneNumberSql = exports.getUserProfileByEmailSql = exports.getUserProfilePublicByUidSql = exports.getUserProfileByUidSql = exports.getAllUserProfileSql = exports.getRegisteredUserByUidSql = void 0;
exports.getRegisteredUserByUidSql = `
SELECT 
    uid,
    join_date,
    email_verified,
...
`;
exports.getUserProfileByUidSql = `
SELECT 
    users.uid,
    user_profiles.first_name,
    user_profiles.last_name,
...
WHERE
    users.uid=$1
`;
exports.getUserProfilePublicByUidSql = `
SELECT 
    users.uid,
    user_profiles.first_name,
    user_profiles.last_name,
...
WHERE
    users.uid=$1
    `;
exports.getUserProfileByEmailSql = `
SELECT 
    users.uid,
    user_profiles.first_name,
    user_profiles.last_name,
...
`;
exports.getUserProfileByPhoneNumberSql = `
SELECT 
    users.uid,
    user_profiles.first_name,
    user_profiles.last_name,
...
`;
exports.searchUserProfileByNameSql = `
SELECT 
    users.uid,
    user_profiles.first_name,
    user_profiles.last_name,
...
WHERE
   ...
   LIKE '%$1%'
`;
exports.getUserBankAccountsSql = `
SELECT 
