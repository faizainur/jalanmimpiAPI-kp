export const getTransactionByIdSql = `
SELECT * FROM transactions
WHERE transaction_id = $1
`;

export const getTransactionsByDonationIdSql = `
SELECT 
    transaction_id,
    user_profiles.uid,
...
export const getTransactionsByUserUidSql = `
SELECT 
    transaction_id,
    transactions.uid,
...
export const getTransactionStatusSql = `
SELECT
    transaction_id,
    status
FROM transactions
...
export const getTotalEarnedByDonationIdSql = `
