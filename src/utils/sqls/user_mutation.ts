...
export const changeEmailVerifiedStateSql = `
UPDATE users SET email_verified=$1
WHERE uid=$2
RETURNING *
`

export const changeProfileIsFilledStateSql = `
UPDATE users SET profile_is_filled=$1
WHERE uid=$2
RETURNING *
`

export const recordUserProfileSql = `
...
export const registerBankAccountSql = `
INSERT INTO bank_accounts(uid, bank_name, account_number, description) 
VALUES ($1, $2, $3, $4)
RETURNING *
`

export const updateBankAccountInfoSql = `
